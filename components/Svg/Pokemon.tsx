...
import module from "./Pokemon.module.css";
...
export function Pokemon({
  ...
  return (
    ...
    >
      ...
      <path
        id="polygon16"
        className={module.st0}
        d="M0 36.6l12 20.3 4.8-4.6L3.7 32.8z"
      />
      <path
        id="polygon18"
        className={module.st1}
      ...
      <path
        id="polygon25"
        className={module.st2}
        d="M145 2.3l-18.5 21.2 5.4-1.5 17.6-22z"
      />
      <path
        id="polygon27"
        className={module.st3}
      ...
      />
      <path id="path94" className={module.st12} d="M115.7 47.5z" />
      <path
        id="path96"
        className={module.st13}
      ...
      <path
        id="polygon172"
        className={module.st16}
        d="M162.8 35.4l-6.2 6 5.9 5.3z"
      />
      <path
        id="path174"
        className={module.st17}
